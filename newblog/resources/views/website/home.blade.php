        ...
        <div class="content">
            ...
            <section class="hero-section" data-scrollax-parent="true" id="sec1">
                <div class="hero-parallax">
                    <div class="bg"  data-bg="{{asset('website/assets/images/bg/1.jpg')}}" data-scrollax="properties: { translateY: '200px' }"></div>
                ...
                <div class="hero-section-wrap fl-wrap">
                    <div class="container">
                        <div class="home-intro">
                            ...
                            <h2>jolleys travel Booking System</h2>
                            <span class="section-separator"></span>
                            <h3>Let's start exploring the world together with jolleys travel</h3>
                        </div>
            ...
            <section id="sec2">
                ...
                <div class="gallery-items fl-wrap mr-bot spad home-grid">
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="listing-counter"><span>79 </span> service</div>
                                <img  src="{{asset('website/assets/images/city/1.jpg')}}"   alt="">
                                <div class="listing-item-cat">
                                    <h3><a href="listing.html">service 1</a></h3>
                    ...
                    <div class="gallery-item gallery-item-second">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <img  src="{{asset('website/assets/images/city/3.jpg')}}"   alt="">
                                <div class="listing-counter"><span>43 </span> services</div>
                                <div class="listing-item-cat">
                                    <h3><a href="listing.html">service 2</a></h3>
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="listing-counter"><span>23 </span> services</div>
                                <img  src="{{asset('website/assets/images/city/1.jpg')}}"   alt="">
                                <div class="listing-item-cat">
                                    <h3><a href="listing.html">service 3</a></h3>
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="listing-counter"><span>57</span> services</div>
                                <img  src="{{asset('website/assets/images/city/1.jpg')}}"   alt="">
                                <div class="listing-item-cat">
                                    <h3><a href="listing.html">service 4</a></h3>
                    ...
                    <div class="gallery-item">
                        <div class="grid-item-holder">
                            <div class="listing-item-grid">
                                <div class="listing-counter"><span>122</span> service</div>
                                <img  src="{{asset('website/assets/images/city/1.jpg')}}"   alt="">
                                <div class="listing-item-cat">
                                    <h3><a href="listing.html">service 5 </a></h3>
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        <a href="listing-single.html"><img src="{{asset('website/assets/images/gal/1.jpg')}}" alt=""></a>
                                        <div class="listing-avatar"><a href="author-single.html"><img src="{{asset('website/assets/images/avatar/1.jpg')}}" alt=""></a>
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                <h3 class="title-sin_map"><a href="listing-single.html">Program 1</a></h3>
                                       ...
                                       <!-- <ul class="facilities-list fl-wrap">
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-category-price">Awg/Price <span>$ 320</span></div>
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                <h3 class="title-sin_map"><a href="listing-single.html">Program 2</a></h3>
                                                <div class="geodir-category-location fl-wrap"><a href="#" class="map-item"><i class="fas fa-map-marker-alt"></i> Aswan </a></div>
                                            </div>
                                        </div>
                                        <p> Class aptent taciti  Mauris ac maximus neque. Nam in mauris quis libero sodales eleifend.</p>
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-opt-link">
                                                <div class="geodir-category-price">Awg/Price <span>$ 120</span></div>
                                            </div>
                                            <div class="geodir-opt-list">
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-opt-link">
                                                <div class="geodir-category-price">Awg/Price <span>$ 80</span></div>
                                            </div>
                                            <div class="geodir-opt-list">
                                ...
                                <article class="geodir-category-listing fl-wrap">
                                    <div class="geodir-category-img">
                                        ...
                                        <div class="geodir-category-opt">
                                            ...
                                            <div class="rate-class-name">
                                                <div class="score"><strong>Program 3</strong>10 Reviews </div>
                                                <span>3.2</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                ...
                                                <div class="geodir-category-location fl-wrap"><a href="#" class="map-item"><i class="fas fa-map-marker-alt"></i> Cairo</a></div>
                                            </div>
                                        </div>
                                        <p> Class aptent taciti  Mauris ac maximus neque. Nam in mauris quis libero sodales eleifend.</p>
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-opt-link">
                                                <div class="geodir-category-price">Awg/Price <span>$ 50</span></div>
                                            </div>
                                            <div class="geodir-opt-list">
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                <h3 class="title-sin_map"><a href="listing-single.html">Program 4</a></h3>
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-opt-link">
                                                <div class="geodir-category-price">Awg/Price <span>$ 210</span></div>
                                            </div>
                                            <div class="geodir-opt-list">
                            ...
                            <div class="listing-item">
                                <article class="geodir-category-listing fl-wrap">
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        ...
                                        <div class="geodir-category-footer fl-wrap">
                                            <div class="geodir-opt-link">
                                                <div class="geodir-category-price">Awg/Price <span>$ 105</span></div>
                                            </div>
                                            <div class="geodir-opt-list">
                        ...
                        <div class="col-md-4">
                            <div class="colomn-text fl-wrap pad-top-column-text_small">
                                <div class="colomn-text-title">
                                    <h3>HOT OFFERS</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas in pulvinar neque. Nulla finibus lobortis pulvinar.</p>
                                    <a href="listing.html" class="btn  color2-bg float-btn">View All HOT OFFER<i class="fas fa-caret-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <article class="card-post">
                                <div class="card-post-img fl-wrap">
                                    <a href="blog-single.html"><img  src="{{asset('website/assets/images/all/1.jpg')}}"   alt=""></a>
                                </div>
