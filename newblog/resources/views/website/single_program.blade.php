                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <h2><span>Premium Plaza Hotel</span></h2>
                                    ...
                                    <div class="gallery-items grid-small-pad  list-single-gallery three-coulms lightgallery">
                                        ...
                                        <div class="gallery-item ">
                                            <div class="grid-item-holder">
                                                <div class="box-item">
                                                    ...
                                                    <a href="{{asset('website/assets/images/gal/1.jpg')}}" class="gal-link popup-image"><i class="fa fa-search"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- 1 end -->
                                        ...
                                        <div class="gallery-item">
                                            <div class="grid-item-holder">
                                                <div class="box-item">
                                                    <img  src="{{asset('website/assets/images/gal/1.jpg')}}"   alt="">
                                                    <div class="more-photos-button dynamic-gal"  data-dynamicPath="[{'src': '{{asset("website/assets/images/gal/1.jpg")}}'}, {'src': '{{asset("website/assets/images/gal/1.jpg")}}'},{'src': '{{asset("website/assets/images/gal/1.jpg")}}'}]">Other <span>4 photos</span><i class="far fa-long-arrow-right"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- 7 end -->
                                        ...
                                        <div class="rooms-item fl-wrap">
                                            ...
                                            <div class="rooms-details">
                                                ...
                                                <div class="facilities-list fl-wrap">
                                                    ...
                                                    <a href="{{url('/Program')}}" class="btn color-bg ajax-link">Details<i class="fas fa-caret-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <!--  rooms-item end -->
                                                    ...
                                                    <div class="cal-item">
                                                        <div class="listsearch-input-item">
                                                            ...
                                                            <select data-placeholder="Room Type" name="repopt"   class="chosen-select no-search-select" >
                                                                ...
                                                                <option value="81">Program - 81$</option>
                                                                <option value="122">Program - 122$</option>
                                                                <option value="310">Program - 310$</option>
                                                            </select>
                                                            <!--data-formula -->
