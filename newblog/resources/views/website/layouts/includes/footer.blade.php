                        ...
                        <div class="footer-carousel-wrap fl-wrap">
                            <div class="footer-carousel fl-wrap">
                                ...
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{asset('website/assets/images/partners/1.png')}}" alt=""></a>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="footer-widget fl-wrap">
                        ...
                        <div class="widget-posts fl-wrap">
                            <ul>
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{asset('website/assets/images/all/1.jpg')}}" class="respimg" alt=""></a>
