                        ...
                        <div class="col-md-8">
                            ...
                            <div class="post-container fl-wrap">
                                ...
                                <div class="article-masonry">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="{{url('/Blog')}}"><img  src="{{asset('website/assets/images/all/1.jpg')}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="{{url('/Blog')}}">Blog Post Title.</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                ...
                                <div class="article-masonry">
                                    <article class="card-post">
                                        ...
                                        <div class="card-post-content fl-wrap">
                                            <h3><a href="{{url('/Blog')}}">Blog Post Title.</a></h3>
                                            <p>In ut odio libero, at vulputate urna. Nulla tristique mi a massa convallis cursus. Nulla eu mi magna. Etiam suscipit commodo gravida. </p>
                                            <div class="post-author"><a href="{{url('/Blog')}}"><img src="{{asset('website/assets/images/avatar/1.jpg')}}" alt=""><span>By , Mery Lynn</span></a></div>
                                            <div class="post-opt">
                                                <ul>
                                                    <li><i class="fal fa-calendar"></i> <span>25 April 2018</span></li>
                                                    <li><i class="fal fa-eye"></i> <span>264</span></li>
