    ...
    <div id="wrapper">
        ...
        <div class="content">
            ...
            <section class="color-bg middle-padding ">
                ...
                <div class="container">
                    <div class="flat-title-wrap">
                        <h2><span>Sightseeing Places  </span></h2>
            ...
            <div class="breadcrumbs-fs fl-wrap">
                <div class="container">
                    <div class="breadcrumbs fl-wrap"><a href="#">Home</a><a href="#">Sightseeing Places </a></div>
                </div>
            </div>
            <!-- section-->
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="post-container fl-wrap">
                                ...
                                <div class="article-masonry">
                                    <article class="card-post">
                                        <div class="card-post-img fl-wrap">
                                            <a href="{{url('/Place/'.$row->id)}}"><img  src="{{asset('img/'.$row->m_img)}}"   alt=""></a>
                                        </div>
                                        <div class="card-post-content fl-wrap">
