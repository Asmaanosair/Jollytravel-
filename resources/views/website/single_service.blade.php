                                        ...
                                        @endif
                                            ...
                                            <div class="single-slider-wrapper fl-wrap">
                                                <div class="slider-nav fl-wrap">
                                                      @php(
                                        $img2=\App\service_img::where('sub_service_id',$service->id)->get()
                                        )
                                        @if(count($img2)==0)
                                          @else
                                ...
                                <div class="list-single-main-item fl-wrap" id="sec4">
                                    ...
                                    <div class="rooms-container fl-wrap">
                                        <!--  rooms-item -->
                                          ...
                                          @php(
                                        $avilable1=\App\sub_service::where('sub_program_id',$service->sub_program_id)->paginate(3)
                                        )
                                ...
                                <div class="box-widget-item fl-wrap">
                                    <div class="box-widget">
                                        <div class="box-widget-content">
                                            ...
                                            @php(
                                            $sub=\App\sub_program::find($service->sub_program_id)
                                           
                                            )
                                           
                                            <span class="header-search-input-item-icon"></span>
                                            <input type="text" name="prog"  value="{{$sub->name_en}}"/>
                                      ...
                                      @foreach($level as $lev)
                                                    ...
                                                    <div class="cal-item">
                                                        ...
                                                        <div class="quantity-item fl-wrap fcit">
                                                            ...
                                                            <div class="quantity">
                                                                <input type="number"  name="child" min="0" max="3" step="1" value="0">
