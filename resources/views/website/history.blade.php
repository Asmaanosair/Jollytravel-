            ...
            <section class="parallax-section single-par" data-scrollax-parent="true">
                ...
                <div class="container">
                    <div class="section-title center-align big-title">
                        ...
                        <h2><span>{{$about->name_en}}</span></h2>
                        <span class="section-separator"></span>
                        <h4>{{$about->s_des_en}}.</h4>
                    </div>
                </div>
                    ...
                    <div class="about-wrap">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="#sec2" class="btn  color-bg float-btn custom-scroll-link">OWNER OF BUSINESS <i class="fal fa-users"></i></a>
                            </div>
                        </div>
                    </div>
