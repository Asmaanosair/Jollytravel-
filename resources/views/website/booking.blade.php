...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="cart-details fl-wrap">
                                <!--cart-details_header-->
                                @php(
                                $sub_program_l=\App\program_l::find($cart->program_l_id)
                                )
                                @if($sub_program_l==null)
                                            @else
                                            @php(
                                ...
                                <div class="cart-details_header">
                                    <a href="#"  class="widget-posts-img"><img src="{{asset('img/'.$sub_program->m_img)}}" class="respimg" alt=""></a>
                                    <div class="widget-posts-descr">
                                        <a href="#" title=""></a>
                                        <div class="listing-rating card-popup-rainingvis" data-starrating2="5"></div>
                                        <div class="geodir-category-location fl-wrap"><a href="#"><i class="fas fa-map-marker-alt"></i>{{$sub_program->name_en}}</a></div>
                                    </div>
                                </div>
                                 @endif
                                  @endif
    ...
    {{--@for($X=1 ; $X <= $count ; $X++)--}}
                                        ...
                                        {{--<li>--}}
                                            {{--Age of child {{$X}} <span><strong>--}}


                                        {{--<select   id="aioConceptName{{$X}}" >--}}
                                            {{--@php(--}}
                                            ...
                                            {{--@foreach($child as $row)--}}
                                                ...
                                                {{--<option value="{{$row->offer}}"> {{$row->age}}</option>--}}
                                        ...
                                        {{--</select>--}}
                                                    ...
                                                    {{--<script>--}}
                                                        ...
                                                        {{--$(function() {--}}
                                                            {{--$("#aioConceptName{{$X}}").on("change", function() {--}}
                                                                {{--$("#debug{{$X}}").text($("#aioConceptName{{$X}}").val());--}}
                                                            {{--}).trigger("change");--}}
                                                        {{--});--}}
                                                    {{--</script>--}}
                                                    {{--<div id="debug{{$X}}"></div>--}}
                                    ...
                                    <div class="profile-edit-container">
                                        <div class="custom-form">
                                            <form action="{{url('/add_book')}}" method="post">
                                                <input type="text"  name="from"placeholder="Your Last Name"  value="{{$cart->from}}" hidden required/>
                                             
                                                <input type="text"  name="to"placeholder="Your Last Name" value="{{$cart->to}}" hidden required/>

                                                <input type="text"  name="level"placeholder="Your Last Name" value="{{$cart->program_l_id}}" hidden required/>
                                                <input type="text"  name="child"placeholder="Your Last Name" value="{{$cart->child}}" hidden required/>
                                                <input type="text"  name="adult"placeholder="Your Last Name"  value="{{$cart->Adult}}" hidden required/>
                                                {{csrf_field()}}
                                                ...
                                                <fieldset class="fl-wrap">
                                                    ...
                                                    <div class="success-table-container">
                                                        <div class="success-table-header fl-wrap">
                                                            ...
                                                            <button  type="submit"  style="margin-left: 70%;" class=" color-bg">Send</button>
                                                        </div>
                                                    </div>
                                                    <span class="fw-separator"></span>
                                                    <a  href="#"  class="previous-form action-button  back-form   color-bg"><i class="fal fa-angle-left"></i> Back</a>
